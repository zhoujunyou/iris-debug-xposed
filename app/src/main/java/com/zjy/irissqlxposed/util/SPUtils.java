package com.zjy.irissqlxposed.util;
...
public final class SPUtils {
     ...
     * @return {@link SPUtils}
     */
    public static SPUtils getInstance(String spName,Context context,int mode) {
    ...
    private SPUtils(final String spName,Context context,int mode) {
